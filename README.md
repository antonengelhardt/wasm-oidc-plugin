...
| `claims` | `map` | The claims to request as defined [here](https://openid.net/specs/openid-connect-core-1_0.html#ClaimsParameter) | `{"id_token":{"groups":null,"username":null}}` | ✅ |
